                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                            <thead class="bg-gray-50 dark:bg-gray-800">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider w-8">#</th>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                <a href="{{ route('product.show', $product->id) }}"
                                                    class="p-1.5 rounded-md text-indigo-600 hover:text-indigo-900 hover:bg-indigo-50 dark:hover:bg-indigo-900/50 transition"
                                                    title="View">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <a href="{{ route('product.edit', $product->id) }}"
                                                    class="p-1.5 rounded-md text-amber-600 hover:text-amber-900 hover:bg-amber-50 dark:hover:bg-amber-900/50 transition"
                                                    title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <form action="{{ route('product.delete', $product->id) }}" method="POST"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="p-1.5 rounded-md text-red-600 hover:text-red-900 hover:bg-red-50 dark:hover:bg-red-900/30 transition"
                                                        title="Delete">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 text-gray-400 opacity-50 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
